let info = {
  name: "Ivy Jon Providencia",
  logo_name: "IJP",
  flat_picture: require("./src/assets/me3.png"),
  config: {
    use_cookies: true,
    navbar: {
      blur: false
  ...
  description:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla id condimentum turpis. In mattis congue tincidunt. Pellentesque porttitor consectetur lorem eget posuere. Integer convallis maximus metus a auctor. Aliquam velit risus, gravida et nulla ac, pretium ultricies risus. Sed elementum in leo eu porttitor. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Suspendisse quis turpis eu lorem consequat lobortis.",
  links: {
